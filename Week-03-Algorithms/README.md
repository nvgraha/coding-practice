# 🖥️ CS50x - Week 03: Algorithms
## 🌟 Overview
This folder contains my solutions for Week 3 of Harvard's CS50x course, focusing on algorithms in C programming. Week 3 explores searching and sorting algorithms, as well as algorithmic efficiency using asymptotic notation. These exercises strengthen my ability to design efficient solutions and analyze their performance, preparing me for more advanced data structures.
## 🧩 Problem Sets
...
- **Tideman**: A program that implements the Tideman voting system, using sorting and graph algorithms to rank candidates. 🥇
...
- **Search**: A lab that implements linear and binary search to find elements in arrays efficiently. 🔍
## 📚 Learning Objectives
...
- **Asymptotic Notation**: Understanding Big O (Big-Oh), Big Ω (Big-Omega), and Big Θ (Big-Theta) to analyze algorithm efficiency.
